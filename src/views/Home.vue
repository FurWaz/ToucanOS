...
import ViewBrowser from './windows/ViewBrowser.vue';
...
export default {
    ...
    methods: {
        ...
        createBrowserWindow() { this.createWindow('Navigateur', ViewBrowser); },
